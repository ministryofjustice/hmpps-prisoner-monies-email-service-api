# hmpps-prisoner-monies-email-service-api

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-prisoner-monies-email-service-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-prisoner-monies-email-service-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-prisoner-monies-email-service-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://prisoner-monies-email-service-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-prisoner-monies-email-service-api/security/policy).
...
## Renaming from HMPPS Prisoner Monies Email Service Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-prisoner-monies-email-service-api=0
```
