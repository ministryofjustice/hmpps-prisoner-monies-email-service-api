package uk.gov.justice.digital.hmpps.prisonermoniesemailserviceapi.integration.health
...
class InfoTest(
  ...
  fun `Info page is accessible`() {
    webTestClient.get()
      ...
      .isOk
      .expectBody()
      .jsonPath("build.name").isEqualTo("hmpps-prisoner-monies-email-service-api")
  }
